 ...
 * 
 */
package com.egoncalves.controlefinanceiro.api.security.token;
...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
	...
	private void adicionarRefreshToken(String refreshToken, HttpServletRequest req, HttpServletResponse resp) {
		...
		refreshTokenCookie.setSecure(properties.getSeguranca().isEnableHttps()); // TODO: Mudar para true em producao
